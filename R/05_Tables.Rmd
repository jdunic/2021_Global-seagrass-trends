  ...
  `Attribution category` = c("None", "Descriptive", "Visual", "Inferential"), 
   Description = c("Study did not attribute change to specific driver(s).",
                   ...
                   "Attribution of change was mentioned only in the discussion 
                    ...
                    trends in seagrass meadow extent. Alternatively, direct 
                    ...
                    extent. These included the use of before-after-control-impact 
                    designs, direct correlations between potential drivers and 
                    temporal trends in seagrass meadow extent, or experiments 
                    testing the effect of drivers and coupled with temporal 
                    trends in seagrass meadow extent.")
   ) %>% 
